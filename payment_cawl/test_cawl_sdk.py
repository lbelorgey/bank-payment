...
def test_simple_api_call():
    ...
    try:
        ...
        available_methods = [method for method in dir(merchant_client) if not method.startswith('_')]
        ...
        try:
            ...
            hc_methods = [method for method in dir(hosted_checkout_client) if not method.startswith('_')]
...
def test_hosted_checkout_minimal():
    ...
    try:
        ...
        print(f"   Has hosted_checkout_specific_input: {hasattr(request, 'hosted_checkout_specific_input')}")
...
def test_hosted_checkout_minimal_without_sdk():
    ...
    try:
        ...
        h = hmac.new(api_secret.encode("utf-8"), string_to_hash.encode("utf-8"), hashlib.sha256)
...
def main():
    ...
    tests = [
        ...
        ("Minimal Hosted Checkout without SDK", test_hosted_checkout_minimal_without_sdk),
    ]
